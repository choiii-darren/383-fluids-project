...
def simulation(tube1_length):
    ...
    while (height > end_height):
        def velocity(tube1_velocity):
          ...
          major_head_loss_1 = major_head_loss(tube1_velocity, tube1_length, tube1_diameter)
          minor_head_loss_1 = minor_head_loss(tube1_velocity,0.5)
          major_head_loss_2 = major_head_loss(tube2_velocity, tube2_length, tube2_diameter)
          minor_head_loss_2 = minor_head_loss(tube2_velocity,0.5)
          bend_head_loss = minor_head_loss(max(tube2_velocity, tube1_velocity), 1.1)
          if major_head_loss_1 + minor_head_loss_1 + major_head_loss_2 + minor_head_loss_2 + bend_head_loss > height:
            return 10000 # Will indicate that this is not the root

          return math.sqrt((2*g*(height - (major_head_loss_1 + minor_head_loss_1 + major_head_loss_2 + minor_head_loss_2 + bend_head_loss)))) - tube1_velocity
        
        v2 = fsolve(velocity, previous_exit_velocity)
